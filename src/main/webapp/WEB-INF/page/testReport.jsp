...
<link
	...
	rel="stylesheet" type="text/css" />
<script type="text/javascript"
	src="${pageContext.request.contextPath }/core/js/testReport.js"></script>
...
<body style="position: relative;">
	<div class="nav-main"
		...
		<ul class="floatTitle nav">
			<li class="floatSkill float_select"><a href="#select">技能选择题</a>
			</li>
			<li class="floatSkill float_system"><a href="#system">编程题</a>
			</li>
			<li class="floatSkill float_aq"><a href="#essays">技能问答题</a>
			</li>
	...
	<div class="content container" style="width: 75% !important">
		<!-- 报告头部分 -->
		<div class="title">
			<span class="title_username"></span> <span>总分：<span
				class="title_score"></span>分</span> <span class="title_score_system">(10分制)</span>
		...
		<div class="report_content">
			...
			<div id="sel_report_content">
				<div id="select"
					style="display:none;height:50px;line-height:50px;border-bottom:2px solid #eeeeee;font-size:18pt;color:rgb(102,186,219);margin-top:50px">
					<span style="padding-left:20px" class="parttitle">技能选择题</span>
				</div>
				<br>
				<div class="score_content" id="graph_overview">
			...
			<div class="systemcontent" id="systemcontent">
				<div id="system" style="height:50px;line-height:50px;border-bottom:2px solid #eeeeee;font-size:18pt;color:rgb(102,186,219);display:none">
					<span style="padding-left:20px" class="parttitle">编程题</span> <span
